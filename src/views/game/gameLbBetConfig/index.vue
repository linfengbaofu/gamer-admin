<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="gameLbBetConfigList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="下注金额" align="center" prop="betAmount" width="100" show-overflow-tooltip="true"/>
      <el-table-column label="倍率列表" align="center" prop="betRate" show-overflow-tooltip="true" />
