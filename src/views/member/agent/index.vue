<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="agentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="ID" :fixed="true" align="center" prop="agentId" />
      ...
      <el-table-column label="代理状态(0-取消;1-正常)" align="center" prop="agentStatus" />
      <el-table-column label="佣金比例" align="center" prop="commissionRate" />
      <el-table-column label="代理率" align="center" prop="agentRate" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="邀请人数" prop="inviteNum">
          <el-input v-model="form.inviteNum" placeholder="请输入邀请人数" />
        </el-form-item>
...
<script>
import { listAgent, getAgent, delAgent, addAgent, updateAgent } from "@/api/member/agent";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除代理编号为"' + agentIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('member/agent/export', {
        ...this.queryParams
